	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				?>
				Apakah anda ingin menghapus data <b class="text-warning"><?= $result[0]["nama"]; ?></b> ?
			</div>
			<div class="modal-footer">
				<button class="btn btn-white" type="button" data-dismiss="modal">Cancel</button>
				<a class="btn btn-danger" href="include/data-pelaksana/proses/proses-hapus.php?id=<?= $id; ?>">Hapus</a>
			</div>
		</div>
	</div>
</div>